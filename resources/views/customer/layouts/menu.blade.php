            ...
            <div class="col-12">
                ...
                <div class="Offcanvas_menu_wrapper">
                    ...
                    <div class="support_info">
                        <p>เบอร์ติดต่อ: <a href="tel:">+66 961632545</a></p>
                    </div>
                    <div class="top_right text-right">
                        <ul>
                            <li><a href="#"> บัญชีของฉัน </a></li>
                            <li><a href="#"> เช็คเอาท์ </a></li>
                        </ul>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <div class="support_info">
                            <p>Email: <a href="mailto:">singsoft.sw@gmail.com</a></p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="top_right text-right">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-md-12">
                        <div class="main_menu menu_position">
                            <nav>
                                <ul>
                                    <li><a href="index-2.html">หน้าหลัก</a></li>
                                    <li><a href="product-details.html">รายการสินค้า</a></li>

                                    <li><a class="active" href="#">ประเภทสินค้า <i
                                                class="fa fa-angle-down"></i></a>
                                        <ul class="sub_menu pages">
                                            <li><a href="#">ถัง 4 กก.</a></li>
                                            <li><a href="#">ถัง 7 กก.</a></li>
                                            <li><a href="#">ถัง 10 กก.</a></li>
                                            <li><a href="#">ถัง 17 กก.</a></li>
